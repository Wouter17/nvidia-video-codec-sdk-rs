...
impl _NV_ENC_BUFFER_FORMAT {
    pub fn pitch(&self, width: u32) -> u32 {
        match self {
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_UNDEFINED => 0,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_NV12 => width / 2, // probably correct
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_YV12 => width / 2,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_IYUV => width * 3,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_YUV444 => width * 3,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_YUV420_10BIT => width * 4,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_YUV444_10BIT => width * 4,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_ARGB => width * 4, // correct
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_ARGB10 => width * 5,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_AYUV => width * 3,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_ABGR => width * 4,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_ABGR10 => width * 5,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_U8 => width * 4,
        }
    }
}
