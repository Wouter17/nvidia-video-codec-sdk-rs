...
impl _NV_ENC_BUFFER_FORMAT {
    pub fn pitch(&self) -> u32 {
        match self {
            ...
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_NV12 => 1,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_YV12 => 1,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_IYUV => 3,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_YUV444 => 3,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_YUV420_10BIT => 4,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_YUV444_10BIT => 4,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_ARGB => 4,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_ARGB10 => 5,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_AYUV => 3,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_ABGR => 4,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_ABGR10 => 5,
            NV_ENC_BUFFER_FORMAT::NV_ENC_BUFFER_FORMAT_U8 => 4,
        }
    }
}
